...
def transform_html():
    ...
    df_casas = pd.DataFrame(columns=['titulo', 'habitaciones', 'banos', 'medio_bano', 'metros_cuadrados', 'precio'])
    ...
    s3.put_object(Body=csv_casas.replace('"', ''), Bucket='zappa-bucket-julian',
